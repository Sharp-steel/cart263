...
//    drawBox.innerHTML= `<p> x: ${e.clientX}, y:${e.clientY} </p>`; //Relative to the browser window
...
//   drawBox.innerHTML+= `<p> offset_x: ${offsetX}, offset_y: ${offsetY} </p>`; //Relative to the bounding box
